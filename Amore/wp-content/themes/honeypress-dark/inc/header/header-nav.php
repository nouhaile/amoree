						...
						<div class="ml-auto">
							 	...
							 	if ( class_exists( 'WooCommerce' ) )
								{
								 		...
								 		if(get_theme_mod('cart_btn_enable',false)==true)
								 		{
												...
												$honeypress_dark_shop_button .= '<a href="'.esc_url($honeypress_dark_cart_link).'" ><span class="cart-total">'.sprintf(_n('%d <span>item</span>', '%d <span>items</span>', $woocommerce->cart->cart_contents_count, 'honeypress-dark'), $woocommerce->cart->cart_contents_count).'</span></a>';
										}
								}
								else
								{
