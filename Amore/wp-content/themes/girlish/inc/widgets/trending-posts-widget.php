...
if ( ! class_exists( 'Bloghill_Trending_Posts' ) ) :
    ...
    class Bloghill_Trending_Posts extends WP_Widget {
        ...
        public function __construct() {
            ...
            parent::__construct( 'girlish_trending_posts', esc_html__( 'TP : Trending Posts', 'girlish' ), $tp_widget_trending_posts );
        }
        ...
        public function form( $instance ) {
            $tp_title      = isset( $instance['title'] ) ? ( $instance['title'] ) : esc_html__( 'Trending Posts', 'girlish' );
            $tp_number     = isset( $instance['number'] ) ? absint( $instance['number'] ) : 5;
            $tp_category   = isset( $instance['category'] ) ? absint( $instance['category'] ) : '';
           ?>
