 ...
 */
class Girlish_Dropdown_Taxonomies_Control extends WP_Customize_Control {
...
class Girlish_Note_Control extends WP_Customize_Control {
...
class Girlish_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class  girlish_Dropdown_Multiple_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="girlish-chosen-select" multiple <?php $this->link(); ?>>
                    <?php
...
class Girlish_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="girlish-chosen-select" <?php $this->link(); ?>>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
 ...
 */
class Girlish_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class  girlish_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="girlish-sortable-list">
 
      <?php
       foreach ( $values_choices as $value ){  ?>

	        <li>
	            <input class="girlish-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
	            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $choices[$value] ); ?> </span>
	          <i class="dashicons dashicons-menu girlish-drag-handle"></i>
	        </li>
        ...
        <li class="sortable-hideme">
          <input class="girlish-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
class Girlish_Customize_Column extends WP_Customize_Control {
	public $type = 'hr';
...
class Girlish_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="girlish-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'girlish' ); ?>" class="girlish-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
class Girlish_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @see WP_Customize_Control
 */
class Girlish_Dropdown_Category_Control extends WP_Customize_Control {
 ...
 * @since  1.0.0
 */
class Girlish_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
...
class Girlish_Multiple_Dropdown_Chooser extends WP_Customize_Control{
	public $type = 'dropdown_chooser';
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="girlish-chosen-select" <?php $this->link(); ?> multiple>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
