...
( function( $ ) {
	...
	if(!hootpload){ wp.customize( 'headings_fontface_style', function( value ) {
		value.bind( function( newval ) {
			...
			css = hootBuildCss( 'headings_fontface_style_trans', cssvalue );
			hootUpdateCss( 'headings_fontface_style_trans', css );

			cssvalue = (newval=='standardi' || newval=='uppercasei') ? 'italic' : 'normal';
			css = hootBuildCss( 'headings_fontface_style', cssvalue );
