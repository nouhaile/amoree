...
add_filter( 'hoot_custom_image_sizes', 'hoot_porto_custom_image_sizes', 5 );
 ...
 * @return array
 */
function hoot_porto_custom_image_sizes( $sizes ) {
	$sizes = array(
		...
		'hoot-medium-thumb' => array(
			'label'          => __( 'Medium Thumbnail', 'hoot-porto' ),
			'width'          => 460,
			'height'         => 430,
			'crop'           => true,
		...
		'hoot-preview-thumb' => array(
			'label'          => __( 'Preview Thumbnail', 'hoot-porto' ),
			'width'          => 465,
			'height'         => 550,
			'crop'           => true,
			'show_in_editor' => false,
		...
		'hoot-large-thumb' => array(
			'label'          => __( 'Large Thumbnail', 'hoot-porto' ),
			'width'          => 690,
			'height'         => 550,
			'crop'           => true,
			'show_in_editor' => false,
		...
		'hoot-preview-large' => array(
			'label'          => __( 'Large Preview', 'hoot-porto' ),
			'width'          => 695,
			'height'         => 500,
			'crop'           => false,
			'show_in_editor' => false,
		...
		'hoot-extra-wide-thumb' => array(
			'label'          => __( 'Extra Wide', 'hoot-porto' ),
			'width'          => 1035,
			'height'         => 425,
			'crop'           => true,
			'show_in_editor' => false,
