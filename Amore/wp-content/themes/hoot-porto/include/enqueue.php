...
/* Add custom scripts. */
add_action( 'wp_enqueue_scripts', 'hoot_porto_enqueue_scripts', 9 );
...
add_action( 'wp_enqueue_scripts', 'hoot_porto_localize_script', 9 );
...
add_action( 'wp_enqueue_scripts', 'hoot_porto_base_enqueue_scripts', 11 );
...
add_action( 'wp_enqueue_scripts', 'hoot_porto_enqueue_styles', 10 );

/* Dequeue font awesome */
add_action( 'wp_enqueue_scripts', 'hoot_porto_dequeue_fontawesome', 99 );
 ...
 * @return void
 */
if ( !function_exists( 'hoot_porto_enqueue_scripts' ) ) :
function hoot_porto_enqueue_scripts() {
 ...
 * @return void
 */
if ( !function_exists( 'hoot_porto_localize_script' ) ) :
function hoot_porto_localize_script() {
 ...
 * @return void
 */
if ( !function_exists( 'hoot_porto_base_enqueue_scripts' ) ) :
function hoot_porto_base_enqueue_scripts() {
 ...
 * @return void
 */
if ( !function_exists( 'hoot_porto_enqueue_styles' ) ) :
function hoot_porto_enqueue_styles() {

	/* Load Google Fonts if 'google-fonts' is active. */
	$style_uri = hoot_porto_google_fonts_enqueue_url();
	if ( $style_uri )
		wp_enqueue_style( 'hoot-porto-googlefont', $style_uri, array(), null );
	...
	add_action('wp_head', 'hoot_porto_preload_fonticon', 5);
 ...
 * @since 1.0
 */
if ( !function_exists( 'hoot_porto_preload_fonticon' ) ) :
function hoot_porto_preload_fonticon() { ?>
 ...
 * @return void
 */
if ( !function_exists( 'hoot_porto_dequeue_fontawesome' ) ) :
function hoot_porto_dequeue_fontawesome() {
