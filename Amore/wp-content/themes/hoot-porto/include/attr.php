...
add_filter( 'hoot_attr_body',     'hoot_porto_attr_body',     7    );
add_filter( 'hoot_attr_header',   'hoot_porto_attr_header',   7, 2 );
add_filter( 'hoot_attr_menu',     'hoot_porto_attr_menu',     7, 2 );
add_filter( 'hoot_attr_content',  'hoot_porto_attr_content',  7    );
add_filter( 'hoot_attr_sidebar',  'hoot_porto_attr_sidebar',  7, 2 );
add_filter( 'hoot_attr_branding', 'hoot_porto_attr_branding', 7    );

/* New Theme Filters */
add_filter( 'hoot_attr_page-wrapper',      'hoot_porto_attr_page_wrapper',      7    );
add_filter( 'hoot_attr_topbar',            'hoot_porto_attr_topbar',            7    );
add_filter( 'hoot_attr_header-part',       'hoot_porto_attr_header_part',       7, 2 );
add_filter( 'hoot_attr_header-aside',      'hoot_porto_attr_header_aside',      7    );
add_filter( 'hoot_attr_below-header',      'hoot_porto_attr_below_header',      7    );
add_filter( 'hoot_attr_main',              'hoot_porto_attr_main',              7    );
add_filter( 'hoot_attr_frontpage-grid',    'hoot_porto_attr_frontpage_grid',    7    );
add_filter( 'hoot_attr_frontpage-content', 'hoot_porto_attr_frontpage_content', 7    );
add_filter( 'hoot_attr_frontpage-area',    'hoot_porto_attr_frontpage_area',    7, 2 );
add_filter( 'hoot_attr_loop-meta-wrap',    'hoot_porto_attr_loop_meta_wrap',    7, 2 );
add_filter( 'hoot_attr_loop-meta',         'hoot_porto_attr_loop_meta',         7, 2 ); // This is a bit more generic (archive / singular etc ) than just for archives
add_filter( 'hoot_attr_loop-title',        'hoot_porto_attr_loop_title',        7, 2 ); // This is a bit more generic (archive / singular etc ) than just for archives
add_filter( 'hoot_attr_loop-description',  'hoot_porto_attr_loop_description',  7, 2 ); // This is a bit more generic (archive / singular etc ) than just for archives
add_filter( 'hoot_attr_content-wrap',      'hoot_porto_attr_content_wrap',      7, 2 );
add_filter( 'hoot_attr_sidebar-wrap',      'hoot_porto_attr_sidebar_wrap',      7, 2 );
add_filter( 'hoot_attr_sub-footer',        'hoot_porto_attr_sub_footer',        7    );
add_filter( 'hoot_attr_post-footer',       'hoot_porto_attr_post_footer',       7    );
 ...
 * @return array
 */
function hoot_porto_attr_body( $attr ) {
 ...
 * @return array
 */
function hoot_porto_attr_header( $attr, $context ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
 ...
 * @return array
 */
function hoot_porto_attr_menu( $attr, $context ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
 ...
 * @return array
 */
function hoot_porto_attr_content( $attr ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];

	$layout_class = hoot_porto_layout_class( 'content' );
 ...
 * @return array
 */
function hoot_porto_attr_sidebar( $attr, $context ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
	if ( !empty( $context ) && ( $context == 'primary' || $context == 'secondary' ) ) {
		$layout_class = hoot_porto_layout_class( "sidebar" );
		if ( !empty( $layout_class ) )
			$attr['class'] .= $layout_class;
	}
 ...
 * @return array
 */
function hoot_porto_attr_branding( $attr ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
 ...
 * @return array
 */
function hoot_porto_attr_page_wrapper( $attr ) {
	...
	$classes = apply_filters( 'hoot_porto_attr_page_wrapper_plugins', array( 'hoot-cf7-style', 'hoot-mapp-style', 'hoot-jetpack-style' ) );
 ...
 * @return array
 */
function hoot_porto_attr_topbar( $attr ) {
	$attr['id'] = 'topbar';
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
	$attr['class'] .= ' topbar';
	return $attr;
 ...
 * @return array
 */
function hoot_porto_attr_header_part( $attr, $context ) {
 ...
 * @return array
 */
function hoot_porto_attr_header_aside( $attr ) {
	$attr['id'] = 'header-aside';
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
	$attr['class'] .= ' header-aside table-cell-mid';
	$side = hoot_get_mod( 'logo_side' );
	if ( $side == 'menu' && function_exists( 'hoot_lib_premium_core' ) && hoot_get_mod( 'menu_background_type' ) == 'background' )
		$attr['class'] .= ' with-menubg';
	return $attr;
}
 ...
 * @return array
 */
function hoot_porto_attr_below_header( $attr ) {
 ...
 * @return array
 */
function hoot_porto_attr_main( $attr ) {
	$attr['id'] = 'main';
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
	$attr['class'] .= ' main';
	return $attr;
 ...
 * @return array
 */
function hoot_porto_attr_frontpage_grid( $attr ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
 ...
 * @return array
 */
function hoot_porto_attr_frontpage_content( $attr ) {
 ...
 * @return array
 */
function hoot_porto_attr_frontpage_area( $attr, $context ) {
 ...
 * @return array
 */
function hoot_porto_attr_loop_meta_wrap( $attr, $context ) {
 ...
 * @return array
 */
function hoot_porto_attr_loop_meta( $attr, $context ) {
 ...
 * @return array
 */
function hoot_porto_attr_loop_title( $attr, $context ) {
 ...
 * @return array
 */
function hoot_porto_attr_loop_description( $attr, $context ) {
 ...
 * @return array
 */
function hoot_porto_attr_content_wrap( $attr, $context ) {
 ...
 * @return array
 */
function hoot_porto_attr_sidebar_wrap( $attr, $context ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
 ...
 * @return array
 */
function hoot_porto_attr_sub_footer( $attr ) {
	$attr['id'] = 'sub-footer';
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
 ...
 * @return array
 */
function hoot_porto_attr_post_footer( $attr ) {
	$attr['id'] = 'post-footer';
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
