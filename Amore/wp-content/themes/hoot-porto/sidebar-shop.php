...
?>
	...
	<aside <?php hoot_attr( 'sidebar', 'primary' ); ?>>
		...
		do_action( 'hoot_porto_sidebar_start', 'shop' );
		...
		elseif ( current_user_can( 'edit_theme_options' ) && hoot_widget_exists( 'WP_Widget_Text' ) ): // plugins like AMP can replace Text widget in widget factory
			...
			the_widget(
				'WP_Widget_Text',
				array(
					'title'  => __( 'Woocommerce Sidebar', 'hoot-porto' ),
		...
		// Template modification Hook
		do_action( 'hoot_porto_sidebar_end', 'shop' );
	...
	?>
		...
		<aside <?php hoot_attr( 'sidebar', 'secondary' ); ?>>
			...
			// Template modification Hook
			do_action( 'hoot_porto_sidebar_start', 'shop-secondary' );
			...
			// Template modification Hook
			do_action( 'hoot_porto_sidebar_end', 'shop-secondary' );
