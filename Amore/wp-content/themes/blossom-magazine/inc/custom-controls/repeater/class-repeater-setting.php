<?php
/**
 * Blossom Magazine Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Blossom_Magazine_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Blossom_Magazine_Repeater_Setting extends WP_Customize_Setting {
