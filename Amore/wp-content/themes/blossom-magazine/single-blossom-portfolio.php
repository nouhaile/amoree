...
$related_image_size = 'blossom-magazine-related';
...
$related_title = get_theme_mod( 'related_portfolio_title', __( 'Related Projects', 'blossom-magazine' ) );
