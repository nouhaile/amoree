 ...
 */
function setto_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function setto_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function setto_sanitize_html( $html ) {
 ...
 */
function setto_sanitize_image( $image, $setting ) {
 ...
 */
function setto_sanitize_nohtml( $nohtml ) {
 ...
 */
function setto_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function setto_sanitize_range_value( $number, $setting ) {
 ...
 */
function setto_sanitize_select( $input, $setting ) {
 ...
 */
function setto_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function setto_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function setto_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
